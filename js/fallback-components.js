    ...
    const navigationHTML = `
        ...
        <nav class="navbar navbar-transparent">
            <div class="nav-container">
                <ul class="nav-menu nav-menu-left">
                    ...
                    <li class="nav-dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="${pagesPath}architektonicke-projekcne-prace.html" class="dropdown-link">Architektonické a projekčné práce</a></li>
                            <li><a href="${pagesPath}inzinierske-prace.html" class="dropdown-link">Inžinierske práce</a></li>
                            <li><a href="${pagesPath}stavebny-autorsky-dozor.html" class="dropdown-link">Stavebný a autorský dozor</a></li>
                            <li><a href="${pagesPath}legalizacia-ciernych-stavieb.html" class="dropdown-link">Legalizácia čiernych stavieb</a></li>
                            <li><a href="${pagesPath}rozpoctovanie-stavieb.html" class="dropdown-link">Rozpočtovanie stavieb</a></li>
                        </ul>
                    </li>
                ...
                <ul class="nav-menu nav-menu-right">
                    ...
                    <li><a href="${pagesPath}blog.html" class="nav-link">Časté otázky</a></li>
        ...
        <div class="mobile-sidebar">
            ...
            <ul class="mobile-nav-menu">
                ...
                <li><a href="${pagesPath}architektonicke-projekcne-prace.html" class="mobile-nav-link">Architektonické a projekčné práce</a></li>
                <li><a href="${pagesPath}inzinierske-prace.html" class="mobile-nav-link">Inžinierske práce</a></li>
                <li><a href="${pagesPath}stavebny-autorsky-dozor.html" class="mobile-nav-link">Stavebný a autorský dozor</a></li>
                <li><a href="${pagesPath}legalizacia-ciernych-stavieb.html" class="mobile-nav-link">Legalizácia čiernych stavieb</a></li>
                <li><a href="${pagesPath}rozpoctovanie-stavieb.html" class="mobile-nav-link">Rozpočtovanie stavieb</a></li>
                ...
                <li><a href="${pagesPath}blog.html" class="mobile-nav-link">Časté otázky</a></li>
            ...
            <div class="footer-bottom">
                <div class="footer-main">
                    ...
                    <div class="footer-contact">
                        <div class="footer-location">
                            <h4>Art Projekt s.r.o.</h4>
                            <p>Oravné 9339/22A<br>
                            917 01 Trnava<br>
                            Slovensko</p>
                            <p><a href="mailto:artprojekt@artprojekt.sk">artprojekt@artprojekt.sk</a></p>
                        </div>
                        
                        <div class="footer-location">
                            <h4>Kontakt</h4>
                            <p><strong>Ing. Peter Horváth</strong><br>
                            <a href="tel:+421905516135">+421 905 516 135</a></p>
                            <p><strong>Ing. Tomáš Kalivoda</strong><br>
                            <a href="tel:+421905335892">+421 905 335 892</a></p>
                            <p><strong>Ing. arch. Zuzana Horváthová</strong><br>
                            <a href="tel:+421908544987">+421 908 544 987</a></p>
                        </div>
                    </div>
                ...
                <div class="footer-copyright">
                    <div class="footer-copyright-left">
                        <p>&copy; Art Projekt s.r.o. 2025 &nbsp;&nbsp; <a href="#" onclick="openPrivacyPopup(); return false;">Ochrana osobných údajov</a> &nbsp;&nbsp; <a href="#" onclick="openCookieSettings(); return false;">Nastavenia cookies</a></p>
                    </div>
            ...
            <div class="privacy-popup-content">
                ...
                <div class="privacy-popup-body">
                    <div class="company-info">
                        <strong>Art Projekt s.r.o.</strong><br>
                        <a href="https://maps.google.com/?q=Oravné+9339/22A,+917+01+Trnava" target="_blank" rel="noopener" style="text-decoration: underline; color: rgb(200, 101, 43);">Oravné 9339/22A, 917 01 Trnava</a><br>
                        Slovenská republika<br>
                        IČO: 44 311 320<br>
                        IČ DPH: SK 2022 65 9672<br>
                        E-mail: artprojekt@artprojekt.sk<br>
                        Tel.: +421 905 516 135
                    </div>
                    ...
                    <p>Na stránke artprojekt.sk prevádzkujeme kontaktný formulár ktorého účelom je umožniť vám:</p>
                    ...
                    <p>V prípade otázok alebo uplatnenia Vašich práv nás môžete kontaktovať na artprojekt@artprojekt.sk alebo telefónnom čísle +421 905 516 135.</p>
